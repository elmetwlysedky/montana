...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">{{__('main.categories')}}  </h3>
        </div><!-- /.box-header -->
        <div class="box-body">
                    ...
                    <td>
                        <div class="input-group-btn">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{route('category.show',$item->id)}}">{{__('main.show')}}</a></li>
                                <li><a href="{{route('category.edit',$item->id)}}">{{__('main.edit')}}</a></li>
                                <li class="divider"></li>
                                <li>
